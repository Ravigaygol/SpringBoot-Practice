package com.ExceptionMain.Cotroller;
...
import com.ExceptionMain.Exception.EmployeeServiceException;
import com.ExceptionMain.Exception.ResourceNotFoundException;
import com.ExceptionMain.Model.Employee;
import com.ExceptionMain.Service.EmployeeService;
...
public class EmployeeController {
	...
	public Employee getEmpl() throws ResourceNotFoundException, EmployeeServiceException {
		try {
			...
			throw new EmployeeServiceException("Internal Server exception  while feteching  data ");
		}
	}
